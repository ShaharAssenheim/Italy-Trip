...
export const days: Day[] = [
  ...
  },
  {
    ...
    routeLabel: 'כ-2 שעות',
    emoji: '🏔️',
    title: 'אגם קארצה — דולומיטים',
    color: '#c0392b',
    tags: ['Lago di Carezza', 'דולומיטים', 'בולצאנו'],
    schedule: [
      { text: '08:30 — יציאה מריבה דל גארדה דרך SS240 ואז A22 צפונה' },
      { text: '10:30 — הגעה לבולצאנו: חניה במרכז, קפה ב-Piazza Walther, זמן חופשי לקפה/מאפה/גלידה' },
      { text: '11:30 — יציאה לדולומיטים דרך SS241 ו-Passo Costalunga — קטע קצר וציורי, שווה לעצור לתמונות' },
      { text: '12:00–13:00 — אגם קארצה: הליכה קצרה סביב האגם, נקודות תצפית — אם יש מזל עם הרוח תקבלו השתקפות מושלמת' },
      { text: '13:30–14:30 — ארוחת צהריים: מואנה (מומלץ — עיירה שקטה ונעימה) או פרדזו (יותר תיירותי)' },
      { text: '14:30–17:00 — חזרה לריבה דרך Val di Fassa (SS48), טרנטו וחזרה' },
    ],
    hotel: DU_LAC,
    locations: [
      {
        ...
        lat: 46.4979,
        lng: 11.3548,
        description: 'עצירת קפה ב-Piazza Walther — עיר תרבות בין איטליה לאוסטריה',
        image: '/images/bolzano.jpg',
        driveTime: 'כ-2 שעות מריבה דל גארדה',
        links: [
          {
            id: 'bolzano-map',
            title: 'Google Maps',
            url: 'https://maps.google.com/?q=Piazza+Walther+Bolzano',
            type: 'map',
          },
        ],
      },
      {
        ...
        lat: 46.4099,
        lng: 11.5773,
        description: 'אגם קסום בלב הדולומיטים עם השתקפות ההרים הירוקים',
        image: '/images/carezza.jpg',
        driveTime: 'כ-30 דקות מבולצאנו',
        links: [
          {
            id: 'carezza-map',
            title: 'Google Maps',
            url: 'https://maps.google.com/?q=Lago+di+Carezza,+Italy',
            type: 'map',
          },
        ],
      },
      {
        ...
        lat: 46.3681,
        lng: 11.6545,
        description: 'עיירה שקטה ב-Val di Fassa — מומלצת לארוחת צהריים',
        image: '/images/moena.jpg',
        driveTime: 'כ-15 דקות מאגם קארצה',
        links: [
          {
            id: 'moena-map',
            title: 'Google Maps',
            url: 'https://maps.google.com/?q=Moena,+Trentino,+Italy',
            type: 'map',
          },
        ],
      },
